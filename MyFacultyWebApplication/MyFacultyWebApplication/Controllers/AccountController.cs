...
using MyFacultyWebApplication.ViewModel;
...
namespace MyFacultyWebApplication.Controllers
{
    public class AccountController : Controller
    {
        ...
        // GET: Accounts/RegisterStudent
        [HttpGet]
        public IActionResult RegisterStudent()
        {
            var students = _context.Students.Where(a => a.UserId == null).Select(a =>
                                  new SelectListItem
                                  {
                                      Value = a.Id.ToString(),
        ...
        public async Task<IActionResult> RegisterStudent(RegisterStudentViewModel model)
        {
            ...
            User user = new User { Email = model.Email, UserName = model.Email, Date = model.Date, IsStudent = true};
            var student = _context.Students.FirstOrDefault(a => a.Id == model.StudentId);
        ...
        public async Task<IActionResult> RegisterTeacher(RegisterTeacherViewModel model)
        {
            ...
            User user = new User { Email = model.Email, UserName = model.Email, Date = model.Date, IsStudent = false };
